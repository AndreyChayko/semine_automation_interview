...
@Component({
  ...
  standalone: true,
  template: `
    <div class="fixed top-20 right-4 z-[200] flex flex-col gap-2.5 w-full max-w-sm pointer-events-none">
      @for (toast of toastService.toasts(); track toast.id) {
        <div
          class="flex items-start gap-3 p-4 rounded-xl shadow-lg border text-sm font-medium pointer-events-auto"
